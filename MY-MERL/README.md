...
La build 110 mostra `v1.0.1 · 110` in Nuova attività e `MY MERL 1.0.1 · 110` in Rubriche, così la versione installata è verificabile direttamente dall'iPhone.
