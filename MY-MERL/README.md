...
La build 140 mostra `v1.0.4 · 140` in Nuova attività e `MY MERL 1.0.4 · 140` in Rubriche, così la versione installata è verificabile direttamente dall'iPhone.
